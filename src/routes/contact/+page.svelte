<main class="flex min-h-screen flex-col gap-2 bg-gray-100">
	<header class="flex items-center gap-56 bg-gray-200 px-8 -mx-6 h-30">
		...
		<a href="/contact" class="font-bold underline decoration-solid hover:decoration-dotted text-gray-800">Contact Us</a>
		<a href="/newsroom" class="underline decoration-solid hover:decoration-dotted text-gray-800">Newsroom</a>
	</header>
    <section class="text-center py-16">
    <h2 class="text-3xl font-bold">Contact Us</h2>
    <p class="text-gray-600 mt-4 max-w-xl mx-auto">Want to give feedback, advice or want to ask anything? Contact Wayne Enterprises.</p>

  <a href="mailto:contact@wayne.com?subject=I would like to ask..." class="mt-6 inline-block bg-black text-white px-6 py-3 hover:bg-gray-800">Contact Us</a>
</section>
</main>