...
<main class="flex min-h-screen flex-col gap-2 bg-gray-100">
	<header class="flex items-center gap-56 bg-gray-200 px-8 -mx-6 h-30">
		...
		<a href="/products" class="font-bold underline decoration-solid hover:decoration-dotted text-gray-800">View Our Products</a>
  ...
  <h2 class="text-3xl font-bold">Enterprise Solutions</h2>
  <p class="text-gray-600 mt-4 max-w-xl mx-auto">For large-scale deployments, infrastructure partnerships, and custom integrations.</p>

  <a href="mailto:sales@wayne.com?subject=Enterprise Inquiry" class="mt-6 inline-block bg-black text-white px-6 py-3 hover:bg-gray-800">Contact Sales</a>
</section>
</main>